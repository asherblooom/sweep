...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_2(KC_GRV, KC_QUOT, KC_DQUO, KC_AMPR, KC_CIRC, KC_EQL, KC_EQL, KC_PLUS, KC_ASTR, KC_DLR, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_HASH, KC_BSLS, KC_TILD, KC_PIPE, KC_PERC, KC_QUES, , KC_MINS, KC_SLSH, KC_UNDS, KC_TAB, LT(2,KC_BSPC), LT(2,KC_SPC), KC_ESC),
