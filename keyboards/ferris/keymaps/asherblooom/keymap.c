...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_split_3x5_2(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_LSFT), LT(1, KC_BSPC), LT(1, KC_SPC), LCTL(KC_ENT)),
                                                              [1] = LAYOUT_split_3x5_2(KC_GRV, KC_QUOT, KC_DQUO, KC_AMPR, KC_CIRC, KC_EQL, KC_EQL, KC_PLUS, KC_ASTR, KC_DLR, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_HASH, KC_BSLS, KC_TILD, KC_PIPE, KC_PERC, KC_QUES, KC_EXLM, KC_MINS, KC_SLSH, KC_UNDS, KC_TAB, LT(2, KC_BSPC), LT(2, KC_SPC), KC_ESC),
